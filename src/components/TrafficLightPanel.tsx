...
/**
 * Admin: upload Anchor Traffic Light Excel, list members by colour, show green-path gaps,
 * and open WhatsApp / email drafts (DeepSeek when available).
 *
 * Side effects: POST upload, GET latest, GET members, POST reminder. Does not send WhatsApp/email
 * itself — click-to-chat / mailto / clipboard only.
 *
